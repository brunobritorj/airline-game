  ...
  return (
    <>
      ...
      <small className="d-block text-end mt-3">
        <a href="https://getbootstrap.com/docs/5.2/examples/offcanvas-navbar/#">All updates</a>
      </small>
      </div>
      <div className="my-3 p-3 bg-body rounded shadow-sm">
      ...
      <div className="d-flex text-muted pt-3">
        ...
        <div className="pb-3 mb-0 small lh-sm border-bottom w-100">
          <div className="d-flex justify-content-between">
            ...
            <a href="https://getbootstrap.com/docs/5.2/examples/offcanvas-navbar/#">Follow</a>
          </div>
      ...
      <small className="d-block text-end mt-3">
        <a href="https://getbootstrap.com/docs/5.2/examples/offcanvas-navbar/#">All suggestions</a>
      </small>
      </div>
    </>
)};
